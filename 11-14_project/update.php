    ...
    <form action="modify.php" method="post">
        <table border="1" align="center">
            ...
            <tr>
                <td>性別</td>
                <td>
                    <input type="radio" id="cSex" name="cSex"
                           value="M" <?php echo ($row["cSex"] == 'M') ? 'checked' : '' ?>>男
                    <input type="radio" id="cSex" name="cSex"
                           value="F" <?php echo ($row["cSex"] == 'F') ? 'checked' : '' ?>>女
                </td>
            </tr>
            <tr>
                <td>生日</td>
                <td><input id="cBirthday" name="cBirthday" type="date" value="<?php echo $row["cBirthday"] ?>"></td>
            </tr>
            <tr>
                <td>電子郵件</td>
